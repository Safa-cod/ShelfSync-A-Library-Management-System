...
class MemberFormDialog(tk.Toplevel):
    ...
    def __init__(self, parent, member=None, on_save=None):
        ...
        # Size & centre: cap at 88% of screen height so buttons always show
    ...
    def _build(self):
        ...
        # Buttons (fixed at bottom — packed BEFORE the scroll area so they
        ...
        # Scrollable canvas in the middle
        ...
        # Status/error message at bottom of fields
